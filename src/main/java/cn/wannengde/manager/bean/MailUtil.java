...
public class MailUtil {
	...
	public MailUtil(){
		...
		try {
			msg.setSubject("万能网站验证邮件");
			msg.setFrom(new InternetAddress("kbq815153947@qq.com"));//设置发件人
			
			transport = session.getTransport();
			transport.connect("kbq815153947@qq.com", "fxrpvzqdwoygbbdj");//设置发件人在该邮箱主机上的用户名密码
