...
public class TimeTool {
    ...
    public static String getLunarTime() {
    	Calendar calendar = Calendar.getInstance();
    	Lunar lunar=TimeTool.converterDate(calendar.getTimeInMillis());
	 ...
	 * Calendar.getInstance(); Lunar
	 * lunar=TimeTool.converterDate(calendar.getTimeInMillis());
	 * System.out.println(lunar);
	 * System.out.println(lunar.getMonth()+"月"+lunar.getDay()+"日"); }
	 */
}
